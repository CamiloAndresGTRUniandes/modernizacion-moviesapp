...
{
    public class EjecutaEliminarRolUsuario : IRequest<Unit>
    {
        public string Username { get; set; }
        public string RolNombre { get; set; }
    }

    public class EjecutaValidador : AbstractValidator<EjecutaEliminarRolUsuario>
    {
    ...
    public class Manejador : IRequestHandler<EjecutaEliminarRolUsuario, Unit>
    {
        ...
        public async Task<Unit> Handle(EjecutaEliminarRolUsuario request, CancellationToken cancellationToken)
        {
